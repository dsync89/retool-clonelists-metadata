...
if __name__ == "__main__":
    ...
    with open('.\clonelists-generator\config-amiga-whd.json', 'r') as file:
    ...
    for platform in json_data['platforms']:
        ...
        retool_clonelist_categories_json_data = load_json(platform['categories'])   
        ...
        if len(retool_clonelist_categories_json_data) > 0:
            result_json['categories'] = retool_clonelist_categories_json_data
